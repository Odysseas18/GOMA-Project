  ...
  <div class="container">
    ...
    <section>
      ...
      <div class="experience-card">
         <h3>Orange — Digital Data Analyst & SEO</h3>
        <ul>
          <li>Reporting Stratégique : Conception de reportings décisionnels (Excel/TCD) 
            et analyse de flux de données pour piloter les KPIs de conversion et identifier les frictions utilisateurs</li>
          <li>Collaboration Agile & PO : Interaction avec les Product Owners pour traduire les besoins business
            en indicateurs de performance et prioriser les évolutions des apps MySosh et Orange et moi</li>
          <li>Pilotage du Trafic & SEO : Collaboration avec la Responsable Trafic pour optimiser le référencement naturel 
            et analyser l'impact du SEO sur l'acquisition et le self-care</li>
          <li>Stratégie Web-to-App : Mise en place de deep-links et optimisation SEO 
            pour fluidifier le parcours client et maximiser l'adoption des applications mobiles</li>
          <li>Ritualité Agile : Participation active aux PI Planning pour synchroniser 
            les feuilles de route data avec les cycles de développement technique</li>
        </ul>
      </div>
